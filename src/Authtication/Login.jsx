...
const Login = () => {
  ...
  return (
    <Zoom>
      <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 md:px-10 bg-gradient-to-br from-blue-100 via-white to-purple-100">
        <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl">
