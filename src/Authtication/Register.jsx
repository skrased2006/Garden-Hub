...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 bg-gradient-to-br from-pink-100 via-white to-blue-100">
      <Zoom>
        <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-sm sm:max-w-md md:max-w-lg animate-fade-in-up">
